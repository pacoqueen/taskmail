		...
		try {
			...
			if (mailId != null) {
				...
				if (text != null) {
					...
					sqlInv += " and (title not like :text or desc like :desc)";
				}
				...
				if (text != null) {
					statInv.bindStringParameter(1, "%" + text + "%");
					statInv.bindStringParameter(2, "%" + text + "%");
				}
			} else if (folder != null) {
				...
				statInv = this.dbConnection.createStatement(sqlInv);
				if (text != null) {
					statInv.bindStringParameter(0, "%" + text + "%");
					statInv.bindStringParameter(1, "%" + text + "%");
				}
			}
